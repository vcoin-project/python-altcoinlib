...
from altcoin.core import CoreVCoinMainParams, CoreVCoinTestNetParams
...
# VCoin main/testnet information
#
# See
# https://github.com/vcoin-project/vcoincore/blob/0.11/src/chainparams.cpp


class VCoinMainParams(CoreVCoinMainParams):
    MESSAGE_START = b'\x05\x05\xb5\x05'
    DEFAULT_PORT = 5530
    RPC_PORT = 5531
    DNS_SEEDS = (('vcoin.com', 'mainnetseed.vcoin.com'))
    BASE58_PREFIXES = {'PUBKEY_ADDR': 70,
                       'SCRIPT_ADDR': 30,
                       'SECRET_KEY': 224}


class VCoinTestNetParams(CoreVCoinTestNetParams):
    MESSAGE_START = b'\x01\xfe\xfe\x05'
    DEFAULT_PORT = 55534
    RPC_PORT = 55535
    DNS_SEEDS = (('Minkiz', 'minkiz.co'))
